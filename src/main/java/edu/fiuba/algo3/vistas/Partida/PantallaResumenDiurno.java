...
public class PantallaResumenDiurno extends Pantalla {

    public PantallaResumenDiurno(
            ControladorResultadoPartida controlador,
            JuegoControlador juegoControlador
    ){

        Label titulo = new Label("Resumen de días");
        estiloTitulo(titulo);
        ...
        for(String texto : controlador.resumenDias()){
